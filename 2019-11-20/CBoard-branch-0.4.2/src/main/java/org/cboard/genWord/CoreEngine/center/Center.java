...
public class Center extends WordTemplete {
    ...
    public static String genDepartReport(String[]pngArray,ReportEntity reportEntity) throws DocumentException, IOException{
        ...
        ColloPriceEntity c1 = new ColloPriceEntity("u1", "p1", "a1");
        ColloPriceEntity c2 = new ColloPriceEntity("u2", "p2", "a2");
        ColloPriceEntity c3 = new ColloPriceEntity("u3", "p3", "a3");
        ArrayList<ColloPriceEntity> list1 = new ArrayList<>();
        list1.add(c1);
        list1.add(c2);
        list1.add(c3);
    ...
    public static void main(String[] args) throws DocumentException, IOException {
        ...
        System.out.println(genDepartReport(sourcePath,reportEntity1));
