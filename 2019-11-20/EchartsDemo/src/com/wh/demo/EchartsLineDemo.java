...
import com.wh.utils.ProxyInvokerHandlerUtil;
...
public class EchartsLineDemo {
    ...
    public static String getCurveLineOption() {
        //数据项一定要匹配
        //如果数据类型不是object[]，那么整个那一列都会为空
        Object[] xdatas=new Object[]{"老年人", "儿童", "妇女", "高血压", "糖尿病", "精神病", "冠心病"};
        //int []xdatas=new int[]{10, 20, 30, 40, 50, 60, 70};
        ...
        ValueAxis valueAxis = new ValueAxis();
        valueAxis.axisLabel().formatter("{value} °C");
        //ProxyInvokerHandlerUtil.processDataInvoker(valueAxis,ydatas);
