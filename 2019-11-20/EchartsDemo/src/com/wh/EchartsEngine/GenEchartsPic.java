...
import static com.wh.demo.EchartsHistogramDemo.genHistogramCommen;
...
import static com.wh.demo.EchartsPiDemo.genPiConmen;
  ...
  private static  String JSpath ="";
    ...
    public static void main(String[] args) throws IOException {
       ...
       // boolean isSave = saveAsJsonFile(JsonFormatUtil.formatJson(getCurveLineOption()), infilePath, infile);
        ...
        boolean isSave = saveAsJsonFile(JsonFormatUtil.formatJson(genHistogramCommen("设置标题")), infilePath, infile);
