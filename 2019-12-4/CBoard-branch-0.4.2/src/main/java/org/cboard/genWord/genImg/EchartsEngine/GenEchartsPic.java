...
public class GenEchartsPic {
  ...
  private static  String JSpath ="";
    ...
    public static  String generateEChart(String infile,String outfile,String JSpath ) throws IOException {
        InputStream inputStream=GenEchartsPic.class.getClassLoader().getResourceAsStream("genEcharts.properties");
        Properties properties=new Properties();
        properties.load(inputStream);
        String PHANTOMJS_PATH=properties.getProperty("PHANTOMJS_PATH");
    ...
    public static String genPiImg(String titile,String subtext,String formatter,Object[]piDatas,Object[] parts)throws IOException{
    ...
    public static String genCyclic2Img(String title,String subtext,String formatter,Object[] piDatas,Object[] Valuedatas,Object[] innerDatas) throws IOException {
        String uuidStr= UUID.randomUUID().toString();
        String outfile=uuidStr + ".png";
        String infile= uuidStr + ".json";
        ...
        boolean isSave = saveAsJsonFile(JsonFormatUtil.formatJson(genCyclic2Common(title,subtext,formatter,piDatas,Valuedatas,innerDatas)), infilePath, infile);
        //System.out.println("json file save "+isSave);
        return generateEChart(infilePath+"\\"+infile,outfilePath);
